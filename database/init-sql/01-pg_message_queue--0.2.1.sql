-- pg message queue easy install on windows.
-- https://github.com/rpdelaney/pg-message-queue/blob/master/pg_message_queue--0.2.1.sql
...
$$ The base message queue catalog.  Unlike in 0.1, all types are supported.$$;
